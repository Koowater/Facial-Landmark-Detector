...
class FacialLandmarkDetector(Model):
    def __init__(self, num_modules=4, num_parts=68):
        ...
        self.m = deepcopy(dummy)
        self.top_m = deepcopy(dummy)
        self.conv_last = deepcopy(dummy)
        self.bn_end = deepcopy(dummy)
        self.l = deepcopy(dummy)
        self.bl = deepcopy(dummy[:-1])
        self.al = deepcopy(dummy[:-1])
